...
class ProfileController extends Controller
{
    public function user() {
        try {
            ...
            Log::error("Error in showing user profile", ["message" => $th->getTraceAsString()]);
    ...
    public function station() {
        try {
            ...
            Log::error("Error in showing station profile", ["message" => $th->getTraceAsString()]);
    ...
    public function rider() {
        try {
            ...
            Log::error("Error in showing rider profile", ["message" => $th->getTraceAsString()]);
