...
export const fetch_station_products = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: fetch_station_products.url(options),
    method: 'get',
})

fetch_station_products.definition = {
    methods: ["get","head"],
...
fetch_station_products.url = (options?: RouteQueryOptions) => {
    return fetch_station_products.definition.url + queryParams(options)
}
 ...
 */
    const fetch_station_productsForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: fetch_station_products.url(options),
        method: 'get',
    })
 ...
 */
        fetch_station_productsForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: fetch_station_products.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
...
const DashboardController = { user, station, fetch_station_products, rider, admin }
