...
export default function ConfirmCreateStation() {
    return (
        <div className="success-content">
            ...
            <div style={{backgroundColor: "#fff3cd", borderRadius: "10px", padding: "15px", marginBottom: "20px", textAlign: "left"}}>
                <p style={{marginBottom: "5px"}}><i className="fas fa-clock"></i> What's next?</p>
            ...
            <Link as={"button"} href={"/login/1"} className="btn btn-primary">Go to Login <FontAwesomeIcon icon={["fas", "sign-in-alt"]} /></Link>
        </div>
    );
}