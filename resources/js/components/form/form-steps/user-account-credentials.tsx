...
export default function UserAccountCredentialsForm({updateFormStep} : {updateFormStep: (step: number) => void}) {
    return (
      <div>
        <form id="accountForm">
          ...
          <button type="button" className="btn btn-primary" onClick={() => updateFormStep(2)} id="nextBtn1">
