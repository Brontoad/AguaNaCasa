...
export default function VerifyContactNumberStation({stationCredentials, contactNumber, updateFormStep} : {stationCredentials: StationCredentials, contactNumber: string, updateFormStep(step: number): void}) {
    ...
    const handleSubmission = () => {
        ...
        router.post('/station', stationCredentials as any, {
